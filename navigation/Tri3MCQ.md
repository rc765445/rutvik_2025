...
# 🚀 Ultimate AP Computer Science Principles Mega‑Guide (2025 Edition)
*A fresh spin on your study blog—expanded, reorganized, and sprinkled with brand-new resources and tips.*
...
## 🎥 Big Ideas + Video Pathways + Challenge Prompts  

> **How to use:** Watch the “Spark” clip first (gets you curious in ≤ 10 min). Then hit the “Deep Dive” playlist. Finally, tackle the Challenge Prompt to lock it in.

| 💡 Big Idea                   | Spark Video (≤ 10 min)                                          | Deep Dive Playlist            | Challenge Prompt                                                      |
|-------------------------------|---------------------------------------------------------------|------------------------------|----------------------------------------------------------------------|
| **1. Creative Development**    | *“How Software Teams Prototype in an Hour”* (Fireship, 8 min)   | AP Daily CRD (8 vids)         | ✏️ *Sketch a flow diagram for an app that tracks homework and suggests breaks—identify at least two abstractions.* |
| **2. Data**                    | *“Lossless vs Lossy in Real Life”* (MinutePhysics, 7 min)       | UTeach Unit 3 playlist        | 🔍 *Compress a 1 MB PNG and a 1 MB JPEG; report new sizes and explain the trade-offs.* |
| **3. Algorithms & Programming**| *“Linear vs Binary Search Visually Explained”* (CS50 Shorts, 6 min) | CodeHS AP CSP Units 4-6      | 🖋️ *Write pseudocode for linear search and binary search.*           |
| **4. Systems & Networks**      | *“How Does the Internet Work?”* (Computerphile, 9 min)         | AP Daily Systems and Networks playlist | 🕵️ *Trace the journey of a packet from your laptop to a website—include all network layers.* |
| **5. Impact of Computing**     | *“How the Digital Divide Affects Communities”* (TEDx Talks, 10 min) | AP Daily Impact playlist     | 💭 *Discuss how the digital divide affects access to education in a rural area versus an urban one.* |
...
| Section               | Details                                                                       |
|-----------------------|-------------------------------------------------------------------------------|
| **MCQs (70%)**         | ~70 multiple-choice questions (single‑select and multi‑select)                |
| **Create Task (30%)**  | Code, video, and explanation                                                  |

---

## 📈 **Study Tips**
- 🧠 Practice writing and tracing pseudocode. [College Board Vocab](https://quizlet.com/215446996/ap-computer-science-principles-vocabulary-flash-cards/)
- 🧪 Use College Board’s Guiding Questions regularly.
- 🎥 Review your Create Task submission and rubrics.
- 🃏 Use flashcards to quiz key vocabulary.
- 💡 Understand both positive and negative impacts of technology.

---

## 📚 **Study & Review Plan: Weak Topics**
...
### 🔘 **3.5 Boolean Expressions — Scored: 25%**
**Review Plan:**
